...
@margin-note{@secref["compilation" #:doc '(lib "syntax-spec-v3/scribblings/main.scrbl")] in the @secref["Basic_Tutorial__State_Machine_Language"
         #:doc '(lib "syntax-spec-v3/scribblings/main.scrbl")] introduces the use of reference compilers.}
